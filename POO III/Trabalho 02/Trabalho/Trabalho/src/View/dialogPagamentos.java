...
public class dialogPagamentos extends javax.swing.JDialog {
    ...
    private Pagamento createObject() {
    ...
    private void populateComponents(Pagamento pagamento) {
        textId.setText(pagamento.getId() + "");
        textNome.setText(pagamento.getNome());
    }

    /**
     * Creates new form dialog Pagamento
     */
    ...
    private void tableDadosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableDadosMouseClicked
        ...
        if (evt.getClickCount() == 2) {
            ...
            int codigo = Integer.parseInt(tableDados.getValueAt(tableDados.getSelectedRow(), 0) + "");
            Pagamento venda = dao.retrieve(Pagamento.class, codigo);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dialogPagamentos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dialogPagamentos dialog = new dialogPagamentos(new javax.swing.JFrame(), true);
