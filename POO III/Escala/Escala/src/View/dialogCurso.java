...
public class dialogCurso extends javax.swing.JDialog {
    ...
    private void loadEnumTurno(){
        DefaultComboBoxModel cbm = new DefaultComboBoxModel(Turnos.values());
    ...
    private void populateComponents(Curso curso){
        textId.setText(curso.getId()+"");
        textNome.setText(curso.getNome());
        comboTurno.setSelectedItem(curso.getTurno());
    }
    //
    ...
    private void listDadosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_listDadosMouseClicked
        ...
        if (evt.getClickCount() == 2){
            Curso curso = (Curso)listDados.getSelectedValue();
    ...
    private void buttonRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonRemoveActionPerformed
        ...
        try{
            dao.delete((Curso)listDados.getSelectedValue());
            this.clearComponents();
            this.loadListCurso();
        }catch(SQLException ex){
            System.out.println("ERRO:"+ex.getMessage());
